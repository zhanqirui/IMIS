<template class="background_style">
   <div
    class="  background_style relative h-full w-full flex flex-justify-center flex-items-center">
  ...
  <div class="card-container">
    ...
    <el-carousel style="width:100%;" :autoplay="false">
      ...
      <el-carousel-item >
        ...
        <el-card  
        class=" el-card  w-100 <sm:w-83 !rounded-4% !border-none  bg-color"
