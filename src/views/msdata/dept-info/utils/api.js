...
const crudRoot = "/MSDATA/deptInfo";
/**
 * 
 * @param {import('./types').IDeptInfoForm} params 
 * @returns 
 */
...
/**
 * 
 * @param {import('./types').IDeptInfoQueryform & { pageIndex: number, pageSize: number }} params 
 * @returns 
 */
...
/**
 * 
 * @param {import('./types').IDeptInfoQueryform } params 
 * @returns 
 */
