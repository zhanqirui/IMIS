...
const crudRoot = "/MSDATA/diagnosisFinalInfo";
/**
 * 
 * @param {import('./types').IDiagnosisFinalInfoForm} params 
 * @returns 
 */
...
/**
 * 
 * @param {import('./types').IDiagnosisFinalInfoQueryform & { pageIndex: number, pageSize: number }} params 
 * @returns 
 */
...
/**
 * 
 * @param {import('./types').IDiagnosisFinalInfoQueryform } params 
 * @returns 
 */
